      ...
      <body className={inter.className}>
        ...
        <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(50% 50% at 50% 50%, rgba(202,34,39,0.35), transparent 70%)',
            }}
          />
          <div
            ...
            style={{
              background:
                'radial-gradient(50% 50% at 50% 50%, rgba(202,34,39,0.2), transparent 70%)',
            }}
          />
        </div>
        ...
        <header className="sticky top-0 z-50 border-b border-white/10 bg-black/60 backdrop-blur">
          <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              <Image src="/brand/logo.svg" alt="SpinHunters" width={28} height={28} />
              <span className="font-bold tracking-wide">SpinHunters</span>
            </Link>
